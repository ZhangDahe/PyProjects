...
-
- how to handle multiple reqclient address verification before further looking at the request
        (This is actually a hook for any processing that needs to look
         at the request before anything else, e.g. logging)uests:
...
class BaseServer:
    ...
    def _handle_request_noblock(self):
        ...
        """
        #!!!get_request()方法 是在  TCPserver,UDPserver中都有.满足对不同类型服务器均可用
        #毕竟不同的协议中 get_request() 的实现是有差别的.
        try:
